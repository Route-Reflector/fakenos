> **This project has moved to [Route-Reflector/simnos](https://github.com/Route-Reflector/simnos).**
...
This is a personal fork of [fakenos/fakenos](https://github.com/fakenos/fakenos), maintained for use in my own development projects.

- AI-assisted development (Claude Code, etc.) is actively used in this fork
- This fork is public for transparency, but is not intended to influence the upstream project
- No pull requests or issues are submitted to the upstream repository
